...
class Growth(FactorBase):
    ...
    @staticmethod
    def historical_egro(tp_historical_growth, factor_historical_growth, dependencies=['net_profit', 'net_profit_pre_year_1', 'net_profit_pre_year_2', 'net_profit_pre_year_3', 'net_profit_pre_year_4']):
    ...
    # 分析师预期增长
    @staticmethod
    def fsalesg(tp_historical_growth, factor_historical_growth, dependencies=['sales_predict', 'sales_real']):
        """
        未来预期营收增长
        :param dependencies:
        :param tp_historical_growth:
        ...
        historical_growth['historical_financing_fearng_latest'] = historical_growth[dependencies].apply(fun, axis=1)
    ...
    @staticmethod
    def fearng(tp_historical_growth, factor_historical_growth, dependencies=['earnings_predict', 'earnings_real']):
        """
        未来预期盈利增长
        :param dependencies:
        :param tp_historical_growth:
    ...
    @staticmethod
    def egibs_long(tp_historical_growth, factor_historical_growth, dependencies=['earnings_predict', 'earnings_real_pre_year_3']):
        """
        净利润增长率
        :param dependencies:
        :param tp_historical_growth:
