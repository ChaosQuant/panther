...
run_rebuild_factor_capital_structure = BashOperator(
    task_id='run_rebuild_factor_capital_structure',
...
run_rebuild_factor_cash_flow = BashOperator(
    task_id='run_rebuild_factor_cash_flow',
...
run_rebuild_factor_earning = BashOperator(
    task_id='run_rebuild_factor_earning',
    bash_command='cd ~/app/panther && python client.py --rebuild=True --packet_name="financial.factor_earning" --class_name="FactorEarning"',
    dag=dag,
)
run_rebuild_factor_historical_growth = BashOperator(
    task_id='run_rebuild_factor_historical_growth',
...
run_rebuild_factor_operation_capacity = BashOperator(
    task_id='run_rebuild_factor_operation_capacity',
...
run_rebuild_factor_per_share_indicators = BashOperator(
    task_id='run_rebuild_factor_per_share_indicators',
...
run_rebuild_factor_revenue_quality = BashOperator(
    task_id='run_rebuild_factor_revenue_quality',
...
run_rebuild_factor_solvency = BashOperator(
    task_id='run_rebuild_factor_solvency',
...
run_rebuild_factor_momentum = BashOperator(
    task_id='run_rebuild_factor_momentum',
...
run_rebuild_factor_power_volume = BashOperator(
    task_id='run_rebuild_factor_power_volume',
...
run_rebuild_factor_price_volume = BashOperator(
    task_id='run_rebuild_factor_price_volume',
...
run_rebuild_factor_reversal = BashOperator(
    task_id='run_rebuild_factor_reversal',
...
run_rebuild_factor_sentiment = BashOperator(
    task_id='run_rebuild_factor_sentiment',
...
run_rebuild_factor_volume = BashOperator(
    task_id='run_rebuild_factor_volume',
    bash_command='cd ~/app/panther && python client.py --rebuild=True --packet_name="technical.factor_volume" --class_name="FactorVolume"',
    dag=dag,
)

run_rebuild_factor_valuation = BashOperator(
    task_id='run_rebuild_factor_valuation',
...
run_rebuild_factor_alpha101 = BashOperator(
    task_id='run_rebuild_factor_alpha101',
    bash_command='cd ~/app/panther && python client.py --rebuild=True --packet_name="alphax.factor_alpha101" --class_name="FactorAlpha101"',
    dag=dag,
)
run_rebuild_factor_alpha191 = BashOperator(
    task_id='run_rebuild_factor_alpha191',
    bash_command='cd ~/app/panther && python client.py --rebuild=True --packet_name="alphax.factor_alpha191" --class_name="FactorAlpha191"',
    dag=dag,
)

run_rebuild_factor_volatility_value = BashOperator(
    task_id='run_rebuild_factor_volatility_value',
...
# run_rebuild_balance_report >> run_rebuild_balance_mrq >> run_rebuild_balance_ttm
# run_rebuild_cash_flow_report >> run_rebuild_cash_flow_mrq >> run_rebuild_cash_flow_ttm
# run_rebuild_income_report >> run_rebuild_income_mrq >> run_rebuild_income_ttm
# run_rebuild_indicator_report >> run_rebuild_indicator_mrq >> run_rebuild_indicator_ttm
