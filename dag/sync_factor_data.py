...
run_update_factor_earning_expectation = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="earning_expectation.factor_earning_expectation" '
...
run_update_factor_capital_structure = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="financial.factor_capital_structure" '
                 '--class_name="FactorCapitalStructure"',
    dag=dag,
)
run_update_factor_cash_flow = BashOperator(
    task_id='run_update_factor_cash_flow',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="financial.factor_cash_flow" '
                 '--class_name="FactorCashFlow"',
    dag=dag,
)
run_update_factor_earning = BashOperator(
    task_id='run_update_factor_earning',
    bash_command='cd ~/app/panther && python cash_client.py --schedule=True --packet_name="financial.factor_earning" '
                 '--class_name="FactorEarning"',
    dag=dag,
)
run_update_factor_historical_growth = BashOperator(
    task_id='run_update_factor_historical_growth',
    bash_command='cd ~/app/panther && python cash_client.py --schedule=True --packet_name="financial.factor_historical_growth" '
...
run_update_factor_operation_capacity = BashOperator(
    ...
    bash_command='cd ~/app/panther && python cash_client.py --schedule=True --packet_name="financial.factor_operation_capacity" '
...
run_update_factor_pre_share_indicators = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="financial.factor_pre_share_indicators" '
...
run_update_factor_revenue_quality = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="financial.factor_revenue_quality" '
                 '--class_name="FactorRevenueQuality"',
    dag=dag,
)
run_update_factor_solvency = BashOperator(
    task_id='run_update_factor_solvency',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="financial.factor_solvency" '
...
run_update_momentum = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_momentum" '
                 '--class_name="FactorMomentum"',
    dag=dag,
)
run_update_power_volume = BashOperator(
    task_id='run_update_power_volume',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_power_volume" '
                 '--class_name="FactorPowerVolume"',
    dag=dag,
)
run_update_price_volume = BashOperator(
    task_id='run_update_price_volume',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_price_volume" '
                 '--class_name="FactorPriceVolume"',
    dag=dag,
)
run_update_reversal = BashOperator(
    task_id='run_update_reversal',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_reversal" '
                 '--class_name="FactorReversal"',
    dag=dag,
)
run_update_sentiment = BashOperator(
    task_id='run_update_sentiment',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_sentiment" '
                 '--class_name="FactorSentiment"',
    dag=dag,
)
run_update_volume = BashOperator(
    task_id='run_update_volume',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="technical.factor_volume" '
...
run_update_factor_valuation = BashOperator(
    ...
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="valuation_estimation.factor_valuation" '
...
run_update_factor_alpha101 = BashOperator(
    task_id='run_update_factor_valuation',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="alphax.factor_alpha101" '
                 '--class_name="FactorAlpha101"',
    dag=dag,
)
run_update_factor_alpha191 = BashOperator(
    task_id='run_update_factor_valuation',
    bash_command='cd ~/app/panther && python client.py --schedule=True --packet_name="alphax.factor_alpha191" '
